...
const users = [
    { name: 'Admin User', email: 'admin@jashnify.com', password: 'password123', role: 'admin' },
    { name: 'Demo User', email: 'user@jashnify.com', password: 'password123', role: 'user' },
    { name: 'Alice Smith', email: 'alice@jashnify.com', password: 'password123', role: 'user' },
    { name: 'Bob Johnson', email: 'bob@jashnify.com', password: 'password123', role: 'user' },
    { name: 'Charlie Dave', email: 'charlie@jashnify.com', password: 'password123', role: 'user' },
    { name: 'Diana Prince', email: 'diana@jashnify.com', password: 'password123', role: 'user' },
    { name: 'Ethan Hunt', email: 'ethan@jashnify.com', password: 'password123', role: 'user' },
    { name: 'Fiona Gallagher', email: 'fiona@jashnify.com', password: 'password123', role: 'user' },
    { name: 'George Miller', email: 'george@jashnify.com', password: 'password123', role: 'user' },
    { name: 'Hannah Montana', email: 'hannah@jashnify.com', password: 'password123', role: 'user' }
];
...
const seedDatabase = async () => {
    try {
        ...
        console.log('-------------------------------------------');
        console.log('Admin Email: admin@jashnify.com');
        console.log('User Email:  user@jashnify.com');
