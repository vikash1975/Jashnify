...
const AdminDashboard = () => {
    ...
    const [formData, setFormData] = useState({
        title: '', description: '', date: '', location: '', category: '', totalSeats: '', ticketPrice: '',availableSeats: '', imageUrl: ''
    });
            ...
            {showEventForm && (
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 mb-8 animation-slideDown">
                    ...
                    <form onSubmit={handleCreateEvent} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <input required type="number" placeholder="Available Seats" className="border px-4 py-3 rounded-lg focus:ring-2 focus:ring-gray-700 outline-none transition" value={formData.availableSeats} onChange={(e) => setFormData({ ...formData, availableSeats: e.target.value })} />
